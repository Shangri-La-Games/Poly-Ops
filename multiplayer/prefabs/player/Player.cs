...
public class Player : KinematicBody
{
    ...
    public void intializeGUI()
    {
        ...
        // Label bulletsLabel = (Label)GetNode("Hud/stats/weapon/container/label_bullets");
        // Label ammoLabel = (Label)GetNode("Hud/stats/weapon/container/label_ammo");
    }
    ...
    private void updateDamage(int id, int damage) { RpcId(id, "inflictDamage", damage); }
